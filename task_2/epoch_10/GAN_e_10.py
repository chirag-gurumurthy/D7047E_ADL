...
class Discriminator(nn.Module):
    ...
    def forward(self, x):
        h = F.relu(self.fc1(x))
        out = self.fc2(h)  #returns raw logits 
        return out
...
if wandb_log: 
    wandb.init(project="conditional-gan-mnist-logistic-e-10")
...
save_dir = 'checkpoints_logistic_e_10'
